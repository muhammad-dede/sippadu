...
@section('title', __('Jenis Kegiatan'))
        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-end col-md-3 col-12">
                <div class="mb-1 breadcrumb-right">
                    <a href="{{ route('jenis-kegiatan.create') }}" class="dt-button create-new btn btn-primary"
                        id="btn-tambah">
                        <span>
                                        ...
                                        <tbody>
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('jenis-kegiatan.destroy', $row->id) }}"
                                                    ...
                                                    <td>
                                                        <a href="{{ route('jenis-kegiatan.edit', $row->id) }}"
