...
@section('title', __('Edit Jenis Kegiatan'))
            ...
            <section id="basic-vertical-layouts">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('Form Edit Jenis Kegiatan') }}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form form-vertical"
                            action="{{ route('jenis-kegiatan.update', $jenis_kegiatan->id) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="nama_jenis_kegiatan"
                                            ...
                                            value="{{ old('nama_jenis_kegiatan') ?? $jenis_kegiatan->nama_jenis_kegiatan }}" />
