        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-end col-md-3 col-12">
                <div class="mb-1 breadcrumb-right">
                    <a href="{{ route('sangsi.create') }}" class="dt-button create-new btn btn-primary" id="btn-tambah">
                        <span>
                                        ...
                                        <tbody>
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>{{ $row->nama_sangsi }}</td>
                                                    <td>
                                                        <form action="{{ route('sangsi.destroy', $row->id) }}"
                                                    ...
                                                    <td>
                                                        <a href="{{ route('sangsi.edit', $row->id) }}"
